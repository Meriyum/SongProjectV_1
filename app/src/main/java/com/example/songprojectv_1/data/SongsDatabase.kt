...
package com.example.songApplication.data
...
import com.example.songprojectv_1.data.SongsDao
    ...
    companion object {
        ...
        fun getDatabase(context: Context): SongsDatabase {
            ...
            return Instance ?: synchronized(this) {
                Room.databaseBuilder(context, SongsDatabase::class.java, "item_database")
